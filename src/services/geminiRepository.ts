    ...
    return [
      {
        id: 'welcome-msg',
        role: 'assistant',
        content: "Hi! I'm **Nova**, your personal AI assistant. You can chat with me, or say commands like *\"Send a WhatsApp message to Rahul asking about the project updates\"*.",
        timestamp: Date.now(),
      },
    ];
  }
    ...
    try {
      ...
      if (data) {
        ...
        return {
          ...
          voicePersona: parsed.voicePersona ?? 'natural_warm',
          voiceRate: parsed.voiceRate ?? 0.98,
